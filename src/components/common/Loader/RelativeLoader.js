...
export default function DocPostSummaryLoader() {
  return (
    <div className="item-container" style={{ border: "none" }} >
      ...
      {/* content */}
      <div style={{ marginTop: "30px", marginBottom: "8px", width: "100%" }}>
        <div className="timeline-item w-100-percents">
          <div className="animated-background" style={{ width: "100%", height: "20px", marginRight: "8px", marginTop: "8px" }}></div>
          <div className="animated-background" style={{ width: "80%", height: "20px", marginRight: "8px", marginTop: "8px" }}></div>
          <div className="animated-background" style={{ width: "90%", height: "20px", marginTop: "8px" }}></div>
        </div>
      </div>

      {/* reaction bar */}
      <div className="reaction-bar" style={{ marginTop: "20px" }}>
        <div className="d-flex mg-top-5px">
          <div className="animated-background" style={{ width: "60px", height: "20px", marginRight: "10px" }}></div>
          <div className="animated-background" style={{ width: "60px", height: "20px", marginRight: "10px" }}></div>
