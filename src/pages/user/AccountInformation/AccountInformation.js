                        ...
                        <div className="user-profile view">
                            ...
                            <div>
                                <div className="h-menu-bar">
                                    <div className="h-menu-item " id={"aci-post-" + this.props.match.params.id} activeClassName='h-menu-item active'>
                                        Bài viết
                                     </div>
                                    <div className="h-menu-item active" id={"aci-doc-" + this.props.match.params.id} activeClassName='h-menu-item active'>
                                        Tài liệu
                                     </div>
                                    <div className="h-menu-item" id={"aci-exc-" + this.props.match.params.id} activeClassName='h-menu-item active'>
                                        Bài tập
                                    </div>
                                    <div className="h-menu-item" id={"aci-exc-" + this.props.match.params.id} activeClassName='h-menu-item active'>
                                        Thành tích
