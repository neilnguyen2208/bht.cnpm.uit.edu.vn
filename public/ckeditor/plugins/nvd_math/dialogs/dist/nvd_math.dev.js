  ...
  return {
    ...
    contents: [{
      ...
      elements: [{
        ...
        id: 'preview',
        type: 'html',
        html: '<div class = "nvd-math-prw" style="text-align:center;">' + '<iframe style="border:0;width:0;height:0;font-size:16px; margin: auto" scrolling="no" frameborder="0" allowTransparency="true" src="' + CKEDITOR.plugins.nvd_math.fixSrc + '"></iframe>' + '</div>',
